...
router.get('/all', (req, res) => {
    utils.getConn().query('select count(*) as cnt from post inner join category where category.category_id = post.post_category_id', (err, table) => {
        ...
        utils.getConn().query( {
            sql: 'select post_id, category_name, post_date, post_title, post_content as post_shot, render_type from post inner join category where category.category_id = post.post_category_id',
